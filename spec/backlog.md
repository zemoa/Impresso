...
| --- | --- | --- | --- |
| IMP-01 | P0 | As a user, I want to select a document or image so that I can print it. | PDF, image, DOCX, and ODF files are accepted. The selected file is visible before submission. |
...
| IMP-05 | P0 | As a user, I want to be informed when no printer is found. | A clear empty state is displayed. The app does not silently fall back to a cloud service. |
